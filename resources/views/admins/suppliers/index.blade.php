...
@section('modals')
    @includeIf('admins.suppliers.modal_add')
    @includeIf('admins.suppliers.modal_edit')
@endsection
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#formAdd').submit(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('supplier.store') }}", /* endpoint */
                    data: formData,
